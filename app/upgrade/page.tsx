        ...
        <div className="wrap">
          <div className="cplans">
            <div className="cplan hot">
              ...
              <Link href="/contact?subject=upgrade-pro" className="btn btn-gold">Contact us to upgrade →</Link>
            </div>
            ...
            <div className="cplan">
              ...
              <Link href="/contact?subject=upgrade-fleet" className="btn btn-ghost" style={{ borderColor: "var(--gold)", color: "var(--gold)" }}>Contact us to upgrade →</Link>
            </div>
          </div>

          <p className="note">
            Payments are being set up — reach out and we&apos;ll activate your plan personally within 24 hours.
          </p>
        </div>
      </section>
