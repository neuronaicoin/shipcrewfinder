...
// Çalıştırmak için: https://shipcrewfinder.com/api/admin/broadcast-premium?secret=CRON_SECRET_DEGERI
export async function GET(req: NextRequest) {
  ...
  for (const p of crewProfiles) {
    if (p.is_premium === true) {
      skippedPremium++;
      continue; // Zaten Premium olanlara gerek yok
    }
