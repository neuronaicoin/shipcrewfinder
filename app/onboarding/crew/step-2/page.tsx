            ...
            >
              ...
              <div className="bg-primary-dark border-2 border-white/10 hover:border-white/20 peer-checked:border-accent peer-checked:bg-accent/5 rounded-2xl p-6 transition-all">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex-shrink-0 w-6 h-6 rounded-full border-2 border-white/30 peer-checked:border-accent peer-checked:bg-accent flex items-center justify-center mt-1 group-hover:border-white/50 transition">
                    <svg
