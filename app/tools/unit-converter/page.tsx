  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0d1030', color: '#eef4fa' }}>
      ...
      <div className="itp-wrap">
        ...
        <div className="itp-title">Trim Interpolation</div>
        <p className="itp-sub">
          Enter your two known trims and their table values — the interpolated result for your actual trim updates instantly. Nothing is saved.
        </p>
