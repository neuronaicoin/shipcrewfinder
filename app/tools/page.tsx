...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Flag State Comparison', desc: '10 major flags — registry type, endorsement process, what actually matters.', href: '/tools/flags', icon: '🏴' },
      ...
      { name: 'BMP5 / Piracy Risk Guide', desc: 'Planning, ship protection measures, and citadel procedures for HRA transits.', href: '/tools/bmp5', icon: '🛡️' },
      ...
      { name: 'Port Entry Documentation', desc: '7 IMO FAL forms, plus US and EU specific requirements.', href: '/tools/port-documentation', icon: '📑' },
