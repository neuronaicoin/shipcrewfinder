...
const post: BlogPost = {
  ...
  heroAlt: "Container ship at sea representing seafarer salaries by rank",
  intro: [
  ...
  sections: [
    {
      heading: "A note on how seafarer pay works",
      paragraphs: [
    ...
    {
      heading: "Deck department salaries",
      paragraphs: [
    ...
    {
      heading: "Engine department salaries",
      paragraphs: [
    ...
    {
      heading: "Catering department salaries",
      paragraphs: [
    ...
    {
      heading: "What moves your salary up or down",
      paragraphs: [
  ...
  faqs: [
    {
      question: "How much does a ship captain make per month?",
      answer:
    ...
    {
      question: "How much does an Able Seaman (A/B) earn?",
      answer:
    ...
    {
      question: "Who earns the most on a ship?",
      answer:
    ...
    {
      question: "Are seafarer salaries paid tax-free?",
      answer:
    ...
    {
      question: "Do salaries differ by vessel type?",
      answer:
