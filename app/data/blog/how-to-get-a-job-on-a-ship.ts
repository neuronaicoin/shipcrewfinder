...
const post: BlogPost = {
  slug: "how-to-get-a-job-on-a-ship",
  title: "How to Get a Job on a Ship: The Complete 2026 Guide for Seafarers",
  description:
  ...
  keywords: [
    ...
    "maritime jobs for beginners",
    "ship crew jobs",
    "how to work on ships",
    "entry level seafarer jobs",
  ],
  heroImage:
    "https://images.unsplash.com/photo-1605281317010-fe5ffe798166?auto=format&fit=crop&w=1600&q=80",
  heroAlt: "Cargo ship at sea representing maritime career opportunities",
  intro: [
  ...
  sections: [
    {
      heading: "1. Understand what employers actually require",
      paragraphs: [
    ...
    {
      heading: "2. Choose a realistic entry point",
      paragraphs: [
    ...
    {
      heading: "3. Build a CV that gets opened",
      paragraphs: [
    ...
    {
      heading: "4. Apply through the right channels",
      paragraphs: [
    ...
    {
      heading: "5. Handle the interview and the offer",
      paragraphs: [
    ...
    {
      heading: "6. Avoid the common mistakes",
      paragraphs: [
  ...
  faqs: [
    {
      question: "How do I get a job on a ship with no experience?",
      answer:
    ...
    {
      question: "What certificates do I need to work on a ship?",
      answer:
    ...
    {
      question: "Do I have to pay an agency to get a job at sea?",
      answer:
    ...
    {
      question: "How long does it take to get a first ship contract?",
      answer:
    ...
    {
      question: "Is it better to use an agency or apply directly?",
      answer:
