      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-primary/85 border-b border-white/10">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/login" className="hidden sm:block text-white/70 hover:text-white text-sm font-medium transition">Login</Link>
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-primary">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 lg:py-36">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-accent/10 border border-accent/30 rounded-full mb-6">
            ...
            {/* BIG BOXED CTAs */}
            <div className="mt-12 grid sm:grid-cols-2 gap-5 max-w-4xl">
              <Link href="/signup/crew" className="group relative overflow-hidden bg-gradient-to-br from-white/[0.05] to-white/[0.02] hover:from-white/[0.08] hover:to-white/[0.04] border-2 border-white/15 hover:border-accent/60 rounded-3xl p-8 md:p-10 transition-all duration-300">
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center gap-2 text-accent font-bold">
                    Get started
                    <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" viewBox="0 0 20 20" fill="currentColor"><path d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" /></svg>
                  </div>
                </div>
              </Link>

              <Link href="/signup/company" className="group relative overflow-hidden bg-gradient-to-br from-white/[0.05] to-white/[0.02] hover:from-white/[0.08] hover:to-white/[0.04] border-2 border-white/15 hover:border-accent/60 rounded-3xl p-8 md:p-10 transition-all duration-300">
                <div className="absolute inset-0 bg-gradient-to-br from-accent/0 to-accent/0 group-hover:from-accent/15 group-hover:to-transparent transition-all duration-500" />
                <div className="relative">
                  <div className="inline-block px-4 py-1.5 bg-accent/15 border border-accent/30 rounded-full mb-5">
        ...
        {/* TRUST BAR */}
        <section className="bg-primary-darker border-y border-white/10 py-12 md:py-14">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
              <div>
                ...
                <div className="space-y-5">
                  {[
                    ...
                    <div key={feature.title} className="flex gap-4">
                      <div className="flex-shrink-0 w-10 h-10 bg-accent/15 border border-accent/30 rounded-lg flex items-center justify-center">
                ...
                <Link href="/signup/crew" className="inline-flex items-center gap-2 mt-10 px-6 py-3 bg-accent hover:bg-accent-dark text-primary font-bold rounded-lg transition shadow-lg shadow-accent/20">
              ...
              <div className="relative lg:sticky lg:top-24">
                ...
                <div className="relative bg-primary border border-white/10 rounded-2xl p-8 lg:p-10">
                  <div className="inline-block px-3 py-1 bg-accent/15 border border-accent/30 rounded-full text-accent text-xs font-extrabold tracking-wide mb-6">
                    CREW PLAN
                  </div>
        ...
        <section className="py-20 md:py-28 bg-primary relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/signup/crew" className="w-full sm:w-auto px-8 py-4 bg-accent hover:bg-accent-dark text-primary font-extrabold rounded-lg transition shadow-lg shadow-accent/30">
                Join as Crew — Free Trial
              </Link>
              <Link href="/signup/company" className="w-full sm:w-auto px-8 py-4 bg-white/10 hover:bg-white/15 text-white font-extrabold rounded-lg transition border border-white/20">
                Hire Talent — 3 Free Views
              </Link>
            </div>
            <p className="text-white/40 text-sm mt-8">Cancel anytime · Trusted by maritime professionals worldwide</p>
          </div>
        </section>
      </main>
